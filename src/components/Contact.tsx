      ...
      <div className="container mx-auto">
        ...
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row gap-8">
          <div className="md:w-1/2 glass-dark backdrop-blur-lg rounded-2xl p-8 shadow-xl animate-fade-in bg-slate-800/50">
            ...
            <div className="space-y-6">
              <div className="flex items-center p-4 bg-slate-700/50 rounded-xl hover:scale-[1.02] transition-transform duration-300">
                ...
                <div>
                  ...
                  <a href="mailto:inezasonia124@gmail.com" className="text-gray-400 hover:text-blue-400 transition-colors duration-300">
            ...
            <div className="mt-8">
              <p className="font-medium mb-4 text-gray-200">Find me on</p>
              <div className="flex space-x-4">
                <a 
                  href="https://github.com/soniaineza" 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="p-3 bg-slate-700/50 rounded-full hover:scale-110 transition-all duration-300 hover:bg-slate-600/50" 
          ...
          <div className="md:w-1/2">
            <form className="glass-dark backdrop-blur-lg rounded-2xl p-8 shadow-xl animate-slide-up bg-slate-800/50">
              <div className="mb-6">
                ...
                <input 
                  type="text" 
                  id="name" 
                  className="w-full px-4 py-3 bg-slate-700/50 text-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-colors duration-300" 
              ...
              <div className="mb-6">
                ...
                <textarea 
                  id="message" 
                  rows={5} 
                  className="w-full px-4 py-3 bg-slate-700/50 text-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-colors duration-300 resize-none" 
                  placeholder="Your message here..."
                ></textarea>
              </div>
              <button 
                type="submit" 
                className="w-full px-6 py-3 bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-lg hover:scale-[1.02] transition-all duration-300 shadow-lg hover:shadow-xl font-medium"
              >
                Send Message
              </button>
            </form>
