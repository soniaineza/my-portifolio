...
export function Header() {
  ...
  return (
    <header className={`fixed w-full z-50 transition-all duration-500 ${
      isScrolled 
        ? 'bg-slate-900/80 backdrop-blur-lg border-b border-white/10 py-2 shadow-2xl'
        : 'bg-transparent py-4'
    }`}>
      <div className="container mx-auto px-4 flex justify-between items-center">
        ...
        >
          <img src="/ChatGPT Image Dec 15, 2025, 12_11_22 PM.png" alt="Sonia Ineza Portfolio" className="h-12 w-auto" />
        </a>
