  ...
  return <div className="min-h-screen bg-gradient-to-r from-gray-900 to-black">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mb-16">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {project.features.map((feature: string, index: number) => <div key={index} className="flex items-start p-4 bg-slate-800/50 rounded-lg border border-slate-700">
          ...
          <section className="mb-16">
            ...
            <div className="flex flex-wrap gap-3">
              {project.techStack.map((tech: string, index: number) => <span key={index} className="px-4 py-2 bg-blue-900/30 text-blue-300 rounded-lg font-medium border border-blue-500/30">
                  {tech}
                </span>)}
            </div>
          </section>
          ...
          {project.responsibilities && <section className="mb-16">
              <h2 className="text-3xl font-bold mb-6 text-white">My Role</h2>
          ...
          {project.impact && <section className="mb-16">
              <h2 className="text-3xl font-bold mb-6 text-white">Impact & Results</h2>
              <div className="grid md:grid-cols-2 gap-4">
                {project.impact.map((item: string, index: number) => <div key={index} className="p-4 bg-slate-800/50 rounded-lg border border-blue-500/20">
      ...
      <div className="bg-slate-900 border-t border-slate-800">
        <div className="container mx-auto px-4 py-16 text-center">
          ...
          <a href="#contact" className="inline-block px-8 py-4 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium">
            Get In Touch
          </a>
        </div>
      </div>
