        ...
        <div className="flex flex-col md:flex-row gap-12">
          <div className="md:w-1/2 glass-dark backdrop-blur-lg rounded-2xl p-8 shadow-xl animate-fade-in bg-slate-800/50">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              I am a Software Engineering student at the **Adventist University of Central Africa (AUCA)**. 
              I specialize in developing high-performance web and mobile applications, with a proven 
              track record in JavaScript, Flutter, and innovative Smart City solutions.
            </p>
            <p className="text-gray-300 mb-6 leading-relaxed">
